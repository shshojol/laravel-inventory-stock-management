<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active"><a href="{{ route('categories.index') }}"><i class="fa fa-list"></i> <span>Category</span></a></li>
            ...
            <li class="active"><a href="{{ route('productsOut.index') }}"><i class="fa fa-minus"></i> <span>Product OUT</span></a></li>

            <li class="active"><a href="{{ route('productsIn.index') }}"><i class="fa fa-plus"></i> <span>Product IN</span></a></li>
